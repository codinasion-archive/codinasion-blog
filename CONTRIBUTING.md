# Welcome to Codinasion Blog contributing guide

Thank you for investing your time in contributing to our project! Any contribution you make will be reflected on [codinasion.vercel.app/blog](https://codinasion.vercel.app/blog/) :sparkles:.
...
If you want to add or modify Codinasion content, [search if an issue already exists](https://github.com/codinasion/codinasion-blog/issues). If a related issue doesn't exist, you can open a new issue using a relevant [issue template](https://github.com/codinasion/codinasion-blog/issues/new/choose).
...
2. Clone the forked repository.
  ...
  ```
  git clone https://github.com/your_username/codinasion-blog
  ```
...
- Add or modify blog in `blog` folder.
...
Once your PR is merged, your contributions will be publicly visible on the [codinasion.vercel.app/blog](https://codinasion.vercel.app/blog/)
